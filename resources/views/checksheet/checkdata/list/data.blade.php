...
@section('content')
        ...
        <form action="{{ url()->current() }}" method="GET">
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search"
                    class="block w-full p-3 pl-10 text-sm bg-gray-400 rounded-xl placeholder-gray-900" name="search"
                    value="{{ request()->query('search') }}" placeholder="Cari...">
                <input type="submit"
    ...
    <div class="w-full overflow-x-auto"  style="overflow-x: auto;">
        <table class="table-auto w-full  border border-red-500 text-center">
            ...
            <tbody class="border border-red-200 ">
                @foreach ($checkdata['data'] as $data)
                    ...
                    <td class="py-5">{{ $data->name }} ({{ $data->npk }})</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
