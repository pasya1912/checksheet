                        ...
                        <tbody class="border border-red-200 ">
                            @foreach ($areaList['data'] as $area)
                                <tr class="hover:bg-gray-500 transition duration-300 ease-in-out">
                                    ...
                                    <td class="py-5">
                                        <a href="{{ route('checksheet.list', ['area' => $area->id]) }}"
                                            class="text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Lihat</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
